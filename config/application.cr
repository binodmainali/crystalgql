...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Crystal Project web application."
  #
  #
  ...
  #
  # settings.secret_key_base= DJTS67QlcaAdEe4jQbt9VXEJCCLLzUv0d4n7OCExu7s
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("crystal-project.log", "w"))
  #
  #
end
